...
//{
//    public class AbstractRepository<T,A> : IRepository<T> where A : IAggregate<T>
//    {
//        private string _aggregatesKey = typeof(AbstractRepository<T,A>) + "_AGGREGATES";
//        private IAggregateModel<T> _aggregateModel;
//
//    /**
