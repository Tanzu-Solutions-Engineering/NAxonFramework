...
namespace NAxonFramework.Common
{
    public sealed class Optional<T> 
    {
         ...
         */
        private static readonly ConcurrentDictionary<Type, object> _empties = new ConcurrentDictionary<Type, object>();

        public static Optional<T> Empty => (Optional<T>) _empties.GetOrAdd(typeof(T), type => new Optional<T>());
        ...
        {
            if (value == null)
                throw new KeyNotFoundException("No value present");
        ...
        public Optional<U> Map<U>(Func<T, U> mapper)
        {
            ...
            {
                return Optional<U>.OfNullable(mapper.Invoke(value));
            }
        }
        ...
        public Optional<U> FlatMap<U>(Func<T, Optional<U>> mapper)
        {
            ...
            {
                return mapper.Invoke(value) ?? throw new NullReferenceException();
            }
        }
